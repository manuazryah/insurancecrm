...
<div class="company-contacts-form form-inline">

        <?php $form = ActiveForm::begin(); ?>

        <div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'company_id')->textInput() ?>
...
</div><div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'telephone')->textInput() ?>

</div><div class='col-md-4 col-sm-6 col-xs-12'>    <?= $form->field($model, 'position')->textInput(['maxlength' => true]) ?>
